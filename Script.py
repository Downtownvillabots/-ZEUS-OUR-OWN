...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    PRE_STREAM = """🔒 ᴛʜɪꜱ ꜰᴇᴀᴛᴜʀᴇ ɪꜱ ᴏɴʟʏ ꜰᴏʀ 🏅 ᴘʀᴇᴍɪᴜᴍ ᴜsᴇʀs

✨ ᴜɴʟᴏᴄᴋ ᴇxᴄʟᴜꜱɪᴠᴇ ᴄᴏɴᴛᴇɴᴛ ᴀɴᴅ ꜰᴇᴀᴛᴜʀᴇs  
...
<blockquote>sʜᴀʀᴇ ᴛʜɪꜱ ʟɪɴᴋ ᴡɪᴛʜ ʏᴏᴜʀ ғʀɪᴇɴᴅs. ᴇᴀᴄʜ ᴛɪᴍᴇ ᴛʜᴇʏ ᴊᴏɪɴ, ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ 10 ʀᴇꜰꜰᴇʀᴀʟ ᴘᴏɪɴᴛs ᴀɴᴅ ᴀꜰᴛᴇʀ 100 ᴘᴏɪɴᴛs ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ 1 ᴍᴏɴᴛʜ ᴘʀᴇᴍɪᴜᴍ sᴜʙsᴄʀɪᴘᴛɪᴏɴ.</blockquote></b>"""
...
🎬 ᴛʜᴇ ᴍᴏᴠɪᴇ ʜᴀꜱ <b>ɴᴏᴛ ʙᴇᴇɴ ʀᴇʟᴇᴀꜱᴇᴅ ʏᴇᴛ</b>. ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ʙᴀᴄᴋ ʟᴀᴛᴇʀ.
...
😔 ᴡᴇ ᴀʀᴇ ꜱᴏʀʀʏ, ʙᴜᴛ ᴛʜɪꜱ ᴍᴏᴠɪᴇ ɪꜱ <b>ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ</b> ɪɴ ᴏᴜʀ ᴅᴀᴛᴀʙᴀꜱᴇ ʀɪɢʜᴛ ɴᴏᴡ.

ʏᴏᴜ ᴄᴀɴ ʀᴇǫᴜᴇꜱᴛ ᴀɴᴏᴛʜᴇʀ ᴍᴏᴠɪᴇ ᴏʀ ᴄʜᴇᴄᴋ ʟᴀᴛᴇʀ.
"""
